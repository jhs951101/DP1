...
public class Util {
	...
	public static final int SHAPE_RECT = 8;  // !
	public static final int RECT_DELETE = 9;  // !
	public static final int RECT_RESIZE = 10;  // !
	public static final int RECT_MOVE = 11;  // !
	
	public static final String[] SHAPE_NAME = {
		"정다각형", "타원형", "다각형", "선분", "연필", "이동", "", "삭제", "사각형", "사각형-삭제", "사각형-조절", "사각형-이동"
	};
